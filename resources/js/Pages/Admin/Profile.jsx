...
const gradientButton =
  "inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#04BBFD] to-[#FB00FF] px-5 py-2.5 text-sm font-semibold text-white transition-opacity duration-200 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#04BBFD]/60 focus:ring-offset-transparent sm:text-base";
    ...
    <AdminLayout>
      ...
      >
        <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h1 className="text-2xl font-bold sm:text-3xl">{profileCopy.title}</h1>
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white/80 px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-200 sm:w-auto sm:text-base"
            >
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-6">
          <div className="flex flex-col gap-8 md:flex-row">
            ...
            <div className="flex w-full max-w-[220px] flex-col items-center gap-4 sm:max-w-xs">
              <div className="relative h-32 w-32 overflow-hidden rounded-3xl border-4 border-slate-200 shadow-lg dark:border-slate-800 sm:h-40 sm:w-40">
                <img
                  src={avatarPreview}
                  alt="Avatar"
              ...
              <div className="text-center">
                ...
                />
                <label htmlFor="avatar" className={gradientButton}>
